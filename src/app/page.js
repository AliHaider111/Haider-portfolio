    ...
    <div>
      ...
      <section id="about" className="py-20 bg-slate-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col md:flex-row gap-12">
            ...
            <div className="md:w-1/2">
              <img src="https://storage.googleapis.com/workspace-0f70711f-8b4e-4d94-86f1-2a93ccde5887/image/704a145f-da8f-477c-aff8-c67a6b988c18.png" alt="Ali Haider working at a modern workspace with multiple monitors showing code and standing desk setup" className="rounded-xl shadow-sm w-full" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="contact" className="py-20 bg-slate-900 text-white">
        ...
        <div>
          ...
          <p className="text-slate-400">+92 324 4354303</p>
        </div>
      </div>
              </div>
              ...
              <div className="mt-8 flex space-x-4">
                ...
                <a href="https://www.linkedin.com/in/ali-haider-9220b9227" className="p-2 bg-slate-800 hover:bg-slate-700 rounded-full transition">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
